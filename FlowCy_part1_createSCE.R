...
# fwrite(list(fileName), "sample_metadata4.csv")
...
convertCSVtoFCS(CSVfiles = CSVfiles[-23], csvDirectory = CSVdirPath, csv2fcsDirectory = FCSdirPath, fileName = fileName[-23])
...
sample_md[, condition := factor(condition, levels = c("BM_TEFF_D28", "BM_TPEX_D28",
                                                      "TUM_TEFF", "TUM_TPEX", "TUM_TTERM"))]
...
saveRDS(sce, file = "SCE_sortsubsets_BMTUM.rds")
